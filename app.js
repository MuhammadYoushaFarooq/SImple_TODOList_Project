    ...
    return `
            <li class="todo_item" data-id="${todo.id}">
                ...
                <div class="todo_actions">
                    <button class="action_btn edit" onclick="todoApp.editTodo(${todo.id})" title="Edit task">
                        <i class="fas fa-edit"></i>
                    </button>
                    <button class="action_btn delete" onclick="todoApp.deleteTodo(${todo.id})" title="Delete task">
